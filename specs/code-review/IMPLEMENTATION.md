...
- Focused CR-078/080/081 adapter tests reject body-forged authority fields,
  ...
  A real disposable Classic-host CR-077 probe sends a foreign-Origin Code
  Review create POST; the host returns 403 before `reviews.db` is created.
  The authenticated TOTP fixture also rejects anonymous same-origin create and
