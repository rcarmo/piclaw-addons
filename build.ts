...
/* ── Index hero ─── */
.hero{background:linear-gradient(135deg,#1e3a5f 0%,#2563eb 100%);color:#fff;padding:4rem 1.5rem 3rem;text-align:center}
.hero-logo{width:120px;height:120px;border-radius:26px;margin-bottom:1.5rem;
...
.hero-sub{font-size:1.1rem;opacity:.78;max-width:540px;margin:0 auto 1.4rem;line-height:1.6}
...
.detail-icon{width:120px;height:120px;border-radius:26px;flex-shrink:0;
...
<div class="detail-hero">
  <div class="detail-hero-inner">
    ...
    <div>
      ...
      <div class="detail-kicker">Add-on</div>
