...
The package declares `typebox` as a peer and ships every Office-specific runtime module. PDF generation discovers Chromium, Chrome or Edge locally; `PICLAW_BROWSER_PATH` can set an explicit executable.
